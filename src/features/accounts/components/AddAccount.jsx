...
import { roles, types } from '../data'

export const AddAccount = () => {
  const { register, control, handleSubmit, setValue, formState: { errors }} = useForm({ resolver: yupResolver(accountValidation)})
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-12 pt-5">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Resident Account</h2>
          ...
          <div className="col-span-6 sm:col-span-2">
            ...
            <SelectField
              ...
              errors={errors}
              options={types}
              placeholder={"Select a Valid ID Type"}
              />
            </div>
