...
import { accountUpdateValidation } from "../validations"
...
export const UpdateAccount = () => {
  ...
  const { register, control, handleSubmit, setValue, formState: { errors, dirtyFields }} = useForm({
    resolver: yupResolver(accountUpdateValidation),
    defaultValues: async () => {
        const { data } = await axiosPrivate.get(getAccount(id))
        setImageSource({ avatar: data.avatar , valid_id: data.valid_id})
        return {
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="col-span-6">
            ...
            <div className="col-span-6">
                ...
                setValue={setValue}
                label="Valid ID"
                imageSource={imageSource.valid_id}
                />
            </div>
