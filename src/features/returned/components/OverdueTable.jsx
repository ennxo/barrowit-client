...
export const OverdueTable = () => {
    ...
    //Filter assets that exceed on return date
    ...
    return ( 
      <Layout title="Overdue Assets" description="Assets that exceed on return date">
                    ...
                    {accounts?.map((account) => (
                      <tr key={account.id}>
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-5">
                          <Link to={`/reservations/approved/details/${account.id}/overdue`} className="text-blue-600 hover:text-blue-900">
