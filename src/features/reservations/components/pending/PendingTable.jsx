...
export const PendingTable = () => {
  const { data: accounts, hasPending } = useFetch(getRequests("pending"))
  
  return (
    <Layout title="Pending Requests" description="Asset's pending request.">
      ...
      <EmptyData array={accounts} message={"No pending requests found"} hasPending={hasPending} />
    </Layout>
  )
}
