...
export const CompletedTable = () => {
  const { data: accounts, hasPending } = useFetch(getRequests("completed"))

  return (
    <Layout title="Completed Requests" description="Asset's completed request.">
      ...
      <EmptyData array={accounts} message={"No completed requests found"} hasPending={hasPending} />
    </Layout>
  )
}
