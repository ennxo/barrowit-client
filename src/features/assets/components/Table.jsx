  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 pt-10">
      <PrintTemplate
        ref={printRef}
        assets={assets}
        title={"Available Asset's Records"}
        subtitle={"A records of all available assets"}
      />
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Available Assets</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all available assets
          </p>
        </div>
