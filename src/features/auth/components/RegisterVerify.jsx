...
export const RegisterVerify = () => {
  ...
  return (
    ...
    <Error error={error.status} message={error.message}/>
      <h2 className="mt-6 text-xl font-bold tracking-tight text-gray-900">Phone Verification</h2>
      <p className="mb-5 text-sm text-gray-600">{`We need to register your phone number: +63${phoneNumber}`}</p>
